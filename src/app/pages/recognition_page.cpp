...
PageContent make_recognition_page_content() {
    return PageContent{
        .id = PageId::Recognition,
        .title = tr("page.recognition.title"),
        .description = tr("page.recognition.description"),
        ...
        .stage_body = trf("content.stage.body", tr("page.recognition.title")),
    };
}
